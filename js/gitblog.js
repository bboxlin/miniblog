var gitblog = function(config) {
    ...
    Menu.prototype = {
        ...
        show: function() {
            ...
            if (Object.keys(config.friends).length != 0) {
                ...
                menu_friend.innerHTML = '<li><text style="font-zise:14px"><span style="color: white;transform:translateX(4px)">Helpful Links：</span></text></li>';
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = 'Powered by Github Issue APIs';
    }
